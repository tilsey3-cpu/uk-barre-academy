export default function Invitation() {
  return (
    <section className="bg-white py-24">
      <div className="max-w-container mx-auto px-6 flex flex-col items-center text-center gap-5">
        <p className="eyebrow">The Invitation</p>
        <h2 className="h-display max-w-2xl">A new standard for Barre education, from day one.</h2>
